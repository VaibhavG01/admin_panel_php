...
<!-- Navbar -->
<nav
  class="relative flex flex-wrap items-center justify-between px-4 py-3 mx-4 mt-4 transition-all shadow-md duration-300 ease-soft-in rounded-xl bg-white lg:flex-nowrap lg:justify-start"
  ...
  <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
    <nav>
      ...
      <h6 class="mb-0 font-bold capitalize"><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Dashboard'; ?></h6>
    </nav>
        ...
        <li class="flex items-center">
          <?php if (isset($_SESSION['name']) && !empty($_SESSION['name'])): ?>
            <a href="index.php?route=profile"
              ...
              <img
                src="<?php echo isset($_SESSION['profile_picture']) ? htmlspecialchars($_SESSION['admin']['profile_picture']) : './assets/img/default-avatar.jpg'; ?>"
                class="inline-flex items-center justify-center mr-2 text-sm text-white h-8 w-8 rounded-full"
                alt="Admin Profile" />
