...
<?php $pageTitle = "Blogs" ?>
     ...
     <div class="p-6 max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Blogs'; ?>
            </h2>
            <a href="index.php?route=blogs_create"
            ...
            <i class="fa fa-plus mr-2"></i> Add New Blog
            </a>
        </div>
        <div class="overflow-x-auto bg-white shadow-md rounded-xl">
            ...
            <thead class="bg-gray-50">
                ...
                <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Blogs Name</th>
                ...
                <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Tags</th>
            ...
            <tbody class="divide-y divide-gray-200 w-full">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo htmlspecialchars($row['blog_name']); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo htmlspecialchars($row['descriptions']); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    <img src="./assets/img/uploads/blogs/<?php echo htmlspecialchars($row['blog_image']); ?>" 
                        class="h-16 w-24 object-cover rounded-md" alt="Blog Image">
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo htmlspecialchars($row['tags']); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo htmlspecialchars($row['author']); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="index.php?route=blogs_edit&id=<?php echo htmlspecialchars($row['id']); ?>" 
                        class="text-fuchsia-600 hover:text-fuchsia-800 font-semibold mr-4">Edit</a>
                    <a href="index.php?route=blogs_delete&id=<?php echo htmlspecialchars($row['id']); ?>" 
