...
<?php require "middleware/admin.php"; ?>
    ...
    <div class="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
        ...
        <form action="index.php?route=blogs_store" method="POST" enctype="multipart/form-data" class="space-y-4">
            <div>
            ...
            <div>
                <button type="submit" 
                    class="px-6 py-2 bg-fuchsia-600 text-black shadow-soft-lg rounded-lg hover:bg-fuchsia-700 transition">Create Blogs</button>
