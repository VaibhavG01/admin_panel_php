...
<?php require "middleware/admin.php"; ?>
    ...
    <div class="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
        <h2 class="text-2xl font-bold mb-6">Add New Departments</h2>
        <form action="index.php?route=departments_store" method="POST" enctype="multipart/form-data" class="space-y-4">
            <div>
            ...
            <div>
                ...
                <input type="file" name="department_image" required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-500">
            </div>
            ...
            <div>
                <button type="submit" 
                    class="px-6 py-2 bg-fuchsia-600 text-black shadow-soft-lg rounded-lg hover:bg-fuchsia-700 transition">Create Department</button>
