...
<div class="p-6 max-w-lg mx-auto bg-white shadow-md rounded-xl">
    ...
    <form method="POST" action="index.php?route=banner_update&id=<?= $banner['id'] ?>" enctype="multipart/form-data" class="space-y-6">
        <div>
            <label for="title" class="block text-sm font-semibold text-slate-700 mb-2">Banner Title</label>
        ...
        <div>
            <img src="assets/img/uploads/banners/<?= $banner['banner_image'] ?>" width="120"><br>
        </div>
        <div>
            <label for="banner_image" class="block text-sm font-semibold text-slate-700 mt-2">Banner Image</label>
        ...
        <div>
            ...
            <input type="checkbox" name="isActive" <?= $banner['isActive'] ? "checked" : "" ?>
        ...
        <div>
            ...
            <i class="fa fa-save mr-2"></i> Update Banner
            </button>
        </div>
        </form>
    </div>
