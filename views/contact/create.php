...
<div class="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
    <h2 class="text-2xl font-bold mb-6">Add New Contact Message</h2>
    <form action="index.php?route=contact_store" method="POST" class="space-y-4">
        ...
        <div>
            <button type="submit" 
                class="px-6 py-2 bg-fuchsia-600 text-black shadow-soft-lg rounded-lg hover:bg-fuchsia-700 transition">Create Contact Message</button>
