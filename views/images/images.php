...
<?php $pageTitle = "Images" ?>

    <div class="p-6 max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-slate-800 capitalize">
            <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Images'; ?>
            </h2>
            <a href="index.php?route=image_create"
            ...
            <i class="fa fa-plus mr-2"></i> Add New Images
            </a>
        </div>
        <div class="overflow-x-auto bg-white shadow-md rounded-xl">
            ...
            <tbody class="divide-y divide-gray-200 w-full">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <img src="./assets/img/uploads/images/<?php echo htmlspecialchars($row['images']); ?>" 
                        class="h-16 w-24 object-cover rounded-md" alt="Images Image">
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="index.php?route=image_edit&id=<?php echo htmlspecialchars($row['id']); ?>" 
                        class="text-fuchsia-600 hover:text-fuchsia-800 font-semibold mr-4">Edit</a>
                    <a href="index.php?route=image_delete&id=<?php echo htmlspecialchars($row['id']); ?>" 
