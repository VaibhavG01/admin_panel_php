...
<?php require "middleware/admin.php"; ?>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Empanelments'; ?>
        </h2>
        <a href="index.php?route=empanelment_create"
        ...
        <i class="fa fa-plus mr-2"></i> Add New Empanelment
        </a>
    </div>
    <div class="overflow-x-auto bg-white shadow-md rounded-xl">
        ...
        <thead class="bg-gray-50">
            ...
            <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Company Name</th>
            <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Type</th>
            <th class="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Logo</th>
        ...
        <tbody class="divide-y divide-gray-200 w-full">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700 break-words"><?php echo htmlspecialchars($row['company_name']); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700"><?php echo htmlspecialchars($row['type']); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                <img src="./assets/img/uploads/empanelments/<?php echo htmlspecialchars($row['company_image']); ?>" 
                    class="h-16 w-24 object-cover rounded-md" alt="Company Logo">
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                <a href="index.php?route=empanelment_edit&id=<?php echo htmlspecialchars($row['id']); ?>" 
                    class="text-fuchsia-600 hover:text-fuchsia-800 font-semibold mr-4">Edit</a>
                <a href="index.php?route=empanelment_delete&id=<?php echo htmlspecialchars($row['id']); ?>" 
                    onclick="return confirm('Are you sure you want to delete this empanelment?')" 
