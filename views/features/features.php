    ...
    <div class="p-4 sm:p-6 w-full mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-slate-800 capitalize">
             <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Features'; ?>
            </h2>
            <a href="index.php?route=feature_create"
            ...
            <i class="fa fa-plus mr-2"></i> Add New Feature
            </a>
        </div>
        <div class="overflow-x-auto bg-white shadow-sm rounded-lg">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-4 py-3 text-sm text-slate-700 break-words"><?php echo htmlspecialchars($row['features_name']); ?></td>
                    <td class="px-4 py-3 text-sm text-slate-700 break-words max-w-xs"><?php echo htmlspecialchars($row['descriptions']); ?></td>
                    <td class="px-4 py-3">
                    <img src="./assets/img/uploads/features/<?php echo htmlspecialchars($row['feature_image']); ?>" 
                        class="h-12 w-16 sm:h-16 sm:w-24 object-cover rounded-md" alt="Feature Image">
                    </td>
                    ...
                    <td class="px-4 py-3 text-sm">
                    <a href="index.php?route=features_edit&id=<?php echo htmlspecialchars($row['id']); ?>" 
                        class="text-fuchsia-600 hover:text-fuchsia-800 font-semibold mr-3">Edit</a>
                    <a href="index.php?route=features_delete&id=<?php echo htmlspecialchars($row['id']); ?>" 
